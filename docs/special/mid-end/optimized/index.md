...
- [更好的HTTP/2优先级以实现更快的网络](https://blog.cloudflare.com/zh-cn/better-http-2-prioritization-for-a-faster-web/)
- [弱网阻塞](https://calendar.perfplanet.com/2020/head-of-line-blocking-in-quic-and-http-3-the-details/)
